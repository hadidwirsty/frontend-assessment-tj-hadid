  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        className={cn(
          "transition-shadows h-full w-full overflow-x-hidden overflow-y-auto rounded-[inherit] outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background data-has-overflow-x:overscroll-x-contain data-has-overflow-y:overscroll-y-contain",
          scrollFade &&
